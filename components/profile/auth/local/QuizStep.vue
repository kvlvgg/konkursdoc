    ...
    <div :class="$style['quiz-content']">
        ...
        <div :class="$style['quiz-answers']">
            <div
                ...
                :class="[$style['quiz-answer-item'], isSelected(item) ? $style['selected'] : '']"
                @click="!multipleChoice ? handleSingleSelect(item) : handleMultipleSelect(item)"
            >
        ...
        <div :class="$style['quiz-block-control']">
            <b-button v-if="!isFirst" variant="outline-primary" @click="$emit('back')"> Назад </b-button>

            <b-button
                variant="gr-primary"
                :class="[$style['quiz-block-control-main'], isFirst ? $style['isfirst'] : '']"
                @click="next"
            >
                Далее
            </b-button>
...
export default {
    ...
    methods: {
         ...
         */
        isSelected(item) {
            return !this.multipleChoice ? item === this.value : this.value.includes(item);
        },
