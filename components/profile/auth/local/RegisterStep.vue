<template>
    <div>
        <h2 class="custom-modal-title">Регистрация аккаунта</h2>

        <b-form class="custom-modal-form" autocomplete="off" novalidate @submit.prevent="register">
            <b-form-group>
                <b-input
                    id="signup-lastname"
            ...
            <p :class="$style['confidential-policy']">
                Регистрируя аккаунт, Вы принимаете наши условия использования,
                <a
                    target="_blank"
                    rel="nofollow noopener"
                    href="http://s3.konkursdoc.pw/static/frontend/privacy-policy-ooo-itdok.pdf"
                    class="btn-link"
          ...
          >
            Зарегистрироваться
                    ...
                    <b-button type="submit" variant="gr-primary"> Зарегистрироваться </b-button>
                </div>
            </b-form-group>
        </b-form>
        ...
        <div class="custom-modal-question">
            <b>Есть аккаунт?</b>
            <b-button variant="link" size="sm" @click="goToLoginForm">
                <b>Войти</b>
            </b-button>
        </div>
    </div>
...
import isPhone from '~/mixins/js-mixins/isPhone.js';
...
export default {
    ...
    mixins: [isEmail, isPhone, capitalizeFirstLetter, isValidPassword],
