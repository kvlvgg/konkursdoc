<template>
    <section id="quiz-block" :class="$style['quiz']">
        <div class="container">
            <Title title="Начните бесплатно" subtitle="Ответьте на вопросы и получите полный доступ" />
            ...
            <div :class="$style['quiz-content']">
                ...
                <div :class="$style['quiz-answers']">
                    <div
                        ...
                        :key="index"
                        :class="[$style['quiz-answer-item'], $style[answerActiveClass(item)]]"
                ...
                <div :class="$style['quiz-answer-action']">
                    <b-button variant="gr-primary" :class="$style['quiz-answer-action-item']" @click="confirmAnswer">{{
                        answerActionText
                    }}</b-button>
                </div>
            </div>
...
export default {
            ...
            answerOptions: {
                ...
                willBeParticipants: [
                    ...
                    { id: 2, select: false, text: 'Получили ЭЦП' },
                    {
                        id: 3,
                        select: false,
                        text: 'Прошли регистрацию на электронных площадках для проведения торгов',
                    },
    ...
    methods: {
        ...
        confirmAnswer() {
            ...
            const answer = this.answerOptions[this.currentQuestion].find(i => i.select === true);
