  ...
  <div>
    ...
    >
      ...
      <template #cell(Изменения)="data">
        <span
          v-if="data.item['Действия'] === 'Загрузил документ'"
        ...
        <a
          v-else-if="data.item['Действия'] === 'Добавил 3 картриджа'"
          :class="$style['btn-to-list']"
        >
          К списку
        </a>
        <span
          v-else-if="data.item['Действия'] === 'Добавил испонителя'"
          :class="$style['document']"
        >
